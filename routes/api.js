...
//single-param api calls

route.get("/getblock/:hash", (req, res) => {
...
route.get("/getblockhash/:index", (req, res) => {
	var dataString = `{"jsonrpc":"1.0","id:curltext","method":"getblock","params":["${req.params.index}"]}`;
	var options = {
		url: `http://${USER}:${PASS}@${IP}:8332/`,
		method: "POST",
		headers: headers,
...
route.get("/getrawtransaction/:id", (req, res) => {
	var dataString = `{"jsonrpc":"1.0","id:curltext","method":"getblock","params":["${req.params.id}"]}`;
	var options = {
		url: `http://${USER}:${PASS}@${IP}:8332/`,
		method: "POST",
		headers: headers,
...
route.get("/decoderawtransaction/:hex", (req, res) => {
	var dataString = `{"jsonrpc":"1.0","id:curltext","method":"getblock","params":["${req.params.hex}"]}`;
	var options = {
		url: `http://${USER}:${PASS}@${IP}:8332/`,
		method: "POST",
		headers: headers,
